...
using Constants = Application.Models.Enums.Constants;

namespace Application.Services;

public class SecurityService(IOptionsMonitor<AppOptions> optionsMonitor, IProductRepository repository) : ISecurityService
{
